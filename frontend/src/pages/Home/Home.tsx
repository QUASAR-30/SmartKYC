      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-12 md:py-24">
        ...
        <div className="flex-1 max-w-xl">
          ...
          <p className="mt-4 text-gray-600 text-lg">
            Votre solution intelligente pour évaluer automatiquement la
            crédibilité des entreprises, détecter les fraudes, analyser les
            documents et sécuriser vos prises de décision.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-xl border border-yellow-600 shadow-lg bg-white hover:shadow-2xl transition">
            ...
            <p className="text-gray-600">
              Analyse intelligente des documents KYC, extraction des données et
              vérification instantanée de leur authenticité.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl border border-yellow-600 shadow-lg bg-white hover:shadow-2xl transition">
            ...
            <p className="text-gray-600">
              Générez un score basé sur les données financières, historiques de
              transactions et comportements commerciaux.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl border border-yellow-600 shadow-lg bg-white hover:shadow-2xl transition">
            ...
            <p className="text-gray-600">
              Systèmes avancés pour signaler automatiquement les anomalies,
              modifications suspectes et risques potentiels.
            </p>
          </div>
        </div>
      </section>
